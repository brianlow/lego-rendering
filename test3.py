...
options = RenderOptions(
    image_filename = "renders/test-blender3.png",
    bounding_box_filename = "renders/test-blender3.txt",
    blender_filename = "renders/test-blender3.blend",
...
renderer.render_part("21", options)
