...
# The importer creates a camera for us. Let aim and move it so the
# part is centered in the frame even after rotating the part
...
bpy.context.scene.render.filepath = os.path.join(output_path, partname + "_{}.png".format(i))
