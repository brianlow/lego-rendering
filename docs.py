...
# lighting_styles = [
#     LightingStyle.DEFAULT, LightingStyle.SOFT, LightingStyle.HARD
# ]
...
for i, part in enumerate(parts):
    ...
    lighting_style = LightingStyle.BRIGHT, # so the white looks almost white
