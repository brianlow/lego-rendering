...
for i in range(num_images):
    ...
    image_filename = os.path.join(output_path, "images", f"{color_id}_{part_num}_{i}.png")
    label_filename = os.path.join(output_path, "labels", f"{color_id}_{part_num}_{i}.txt")
